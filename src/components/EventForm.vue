<template>
    <form action="" class="form">
        ...
        <div class="form-group form-group--datepicker" :class="{'form-group--datepicker--filled' : isFilled}">
            <datepicker v-model="concertDate" monday-first v-on:selected="isFilled = true" input-class="form-control" required></datepicker>
...
export default {
    ...
    computed: {
        ...
        concertDate: {
            get() {
                if(this.$store.state.selectedConcert.details.date != "") {
                    this.isFilled = true;
                } else {
                    this.isFilled = false;
                }
                return this.$store.state.selectedConcert.details.date
            },
            set(val) {
